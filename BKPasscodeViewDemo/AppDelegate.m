...
@property (strong, nonatomic) ASDemoController * demoController;
...
//    self.mainViewController = [[MainViewController alloc] initWithStyle:UITableViewStyleGrouped];
    ...
    self.demoController = [[ASDemoController alloc] initWithNibName:@"ASDemoController" bundle:nil];

    UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:self.demoController];
//    [navController setToolbarHidden:YES];
//    [navController setNavigationBarHidden:YES];
//    navController.wantsFullScreenLayout = YES;
//    [navController setHidesBottomBarWhenPushed:YES];
